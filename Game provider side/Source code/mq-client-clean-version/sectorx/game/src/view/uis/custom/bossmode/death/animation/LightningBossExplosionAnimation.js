...
class LightningBossExplosionAnimation extends Sprite
{
	...
	_startSmokeOnce(aIndex)
	{
		...
		let lSmoke_spr = this._fSmoke_spr_arr[aIndex] = this._fContainerSmoke_spr_arr[aIndex].addChild(APP.library.getSpriteFromAtlas('boss_mode/lightning/smoke_'+param.asset));
	...
	_startLightParticleOnce(aIndex)
	{
		...
		let lLightParticle_spr = this._fLightParticle_spr_arr[aIndex] = this._fContainerLightParticle_spr_arr[aIndex].addChild(APP.library.getSpriteFromAtlas('common/light_particle'));
