	...
	if (!lightning_textures)
	{
		lightning_textures = AtlasSprite.getFrames(
			[
				...
				APP.library.getAsset("boss_mode/lightning/1lightning_1")
			],
			[
...
class LightningBossAppearanceView extends AppearanceView
{
	...
	_startLight5()
	{
		let lLight5_spr = this._fLight5_spr = this._fLight5Container_spr.addChild(APP.library.getSpriteFromAtlas('common/misty_flare'));
