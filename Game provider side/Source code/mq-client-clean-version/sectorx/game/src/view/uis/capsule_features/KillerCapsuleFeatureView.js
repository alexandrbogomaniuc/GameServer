...
class KillerCapsuleFeatureView extends SimpleUIView
{
	...
	{
		return this._fIsAnimationPlating_bl;
	}
	...
	{
		this._fAffectedEnemiesInfo_obj_arr = aTargets_obj_arr;
	}
	...
	constructor()
	{
		...
		this._fIsAnimationPlating_bl = null;
	}
	...
	_startAnimation()
	{
		this._fIsAnimationPlating_bl = true;
	...
	_interrupt()
	{
		...
		this._fIsAnimationPlating_bl = false;
		this.emit(KillerCapsuleFeatureView.EVENT_ON_ALL_ANIMATIONS_COMPLETED);
	}
