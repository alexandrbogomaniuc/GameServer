...
class BattlegroundResultPotPayoutIndicatorView extends IndicatorView
{
	//INIT...
	_initIndicatorView()
	{
		...
		let l_s = this.addChild(APP.library.getSprite("round_result/battleground/gradient"));
		l_s.position.set(MAX_WIDTH / 2 + l_s.width / 2 + 3, 0);

		l_s = this.addChild(APP.library.getSprite("round_result/battleground/gradient"));
		l_s.scale.set(-1, 1);
		l_s.position.set( -MAX_WIDTH / 2 - l_s.width / 2 - 3, 0);
	}
	//...INIT
