...
class EarthAppearanceView extends AppearanceView {
	...
	{
		let lBlackSolid_spr = this._fBlackSolid_spr = this._fBlackSolidContainer_spr.addChild(APP.library.getSpriteFromAtlas('boss_mode/earth/black_solid'));
	...
	{
		let lFXExplosionTrail_spr = this._fFXExplosionTrail_spr = this._fFXExplosionTrailContainer_spr.addChild(APP.library.getSpriteFromAtlas('boss_mode/earth/explosion_trail'));
	...
	{
		let lSmoke = APP.library.getSpriteFromAtlas(aName_srt);
