...
{	
	...
	{
		let lLight51_spr = this._fLight51_spr = this._fLight51Container_spr.addChild(APP.library.getSpriteFromAtlas('common/misty_flare'));
	...
	{
		let lLight52_spr = this._fLight52_spr = this._fLight52Container_spr.addChild(APP.library.getSpriteFromAtlas('common/misty_flare'));
