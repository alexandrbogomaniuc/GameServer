...
class EarthBossDeathFxAnimation extends BossDeathFxAnimation
{
	...
	{
		this._fLightParticle_spr = APP.gameScreen.gameFieldController.screenField.addChild(APP.library.getSpriteFromAtlas("common/light_particle"));
	...
	_startFinalExplosion()
	{
		...
		{
			let lSmoke_spr = lContainer_sprt.addChild(APP.library.getSpriteFromAtlas("boss_mode/earth/smoke_6"));
			lSmoke_spr.alpha = 0;
		...
		for (let i=0; i < ORANGE_SMOKES_INFO.length; i++)
		{
			...
			let lSmoke_spr = lContainer_sprt.addChild(APP.library.getSpriteFromAtlas("boss_mode/earth/smoke_orange"));
		...
		{
			let lLight_spr = lContainer_sprt.addChild(APP.library.getSpriteFromAtlas("common/light_particle"));
