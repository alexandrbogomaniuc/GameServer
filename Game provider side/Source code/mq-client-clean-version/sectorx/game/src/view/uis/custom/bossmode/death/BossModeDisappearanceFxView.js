...
class BossModeDisappearanceFxView extends Sprite
{
	...
	startCoinsExplodeAnimation(aPosition_pt)
	{
		this._startCoinsExplodeAnimation(aPosition_pt);
	}
	...
	_startCoinsExplodeAnimation(aPosition_pt)
	{
		this._fExplosionCompleted_bln = false;

		this._fCoinsExplosionAnimation_cea = APP.gameScreen.gameFieldController.bossModeDisappearingContainerInfo.container.addChild(new CoinsExplosionAnimation(this._fBossType_str, this._fIsCoPlayerWin_bln));
		this._fCoinsExplosionAnimation_cea.zIndex = APP.gameScreen.gameFieldController.bossModeDisappearingContainerInfo.zIndex;
		let lPos_obj = {x: aPosition_pt.x + this._coinsExplodePosition.x, y: aPosition_pt.y + this._coinsExplodePosition.y};
		this._fCoinsExplosionAnimation_cea.position.set(aPosition_pt.x, aPosition_pt.y);
	...
	_createDeathSmokeBurst()
	{
		...
		lDeathSmokeBurst_sprt.animationSpeed = 0.8; //48/60; 
	...
	_createDeathGroundSmoke()
	{
		...
		groundSmoke.animationSpeed = 0.8; //48/60;
	...
	destroy()
	{
		this._fCoinsExplosionAnimation_cea && this._fCoinsExplosionAnimation_cea.destroy();
		this._fCoinsExplosionAnimation_cea = null;
