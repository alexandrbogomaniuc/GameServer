...
class LightningBossSmokeLightParticleAnimation extends Sprite
{
	...
	_startParticle(aIndex)
	{
		...
		let lParticle_spr = this._fParticle_spr_arr[aIndex] = this._fContainerParticle_spr_arr[aIndex].addChild(APP.library.getSpriteFromAtlas('common/light_particle'));
