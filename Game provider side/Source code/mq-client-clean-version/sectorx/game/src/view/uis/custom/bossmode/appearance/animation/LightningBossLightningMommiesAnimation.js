...
class LightningBossLightningMommiesAnimation extends Sprite
{
	...
	{
		let lLightningParticleOne_spr = this._fIntroLightningParticleOne_spr = this._fIntroLightningparticleContainerOne_spr.addChild(APP.library.getSpriteFromAtlas('common/light_particle'));
		...
		let lLightningParticleTwo_spr = this._fIntroLightningParticleTwo_spr = this._fIntroLightningparticleContainerTwo_spr.addChild(APP.library.getSpriteFromAtlas('common/light_particle'));
