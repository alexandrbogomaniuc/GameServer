...
class FireBossCaptionView extends BossModeCaptionView
{
	...
	__startCaptionAnimation()
	{
		if (APP.profilingController.info.isVfxProfileValueMediumOrGreater)
		{
			this._fBacgroundGlow_spr = this.__fCaptionContainer_sprt.addChild(APP.library.getSprite("boss_mode/fire/hole/glow"));
	...
	{
		let lFlare_spr = this.__fBackgroundContainer_sprt.addChild(APP.library.getSprite("boss_mode/fire/hole/glow"));
