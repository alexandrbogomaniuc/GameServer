...
const EMITTER_SETTINGS = {
	...
	dispersion:		40, //px
	intense:		{
		[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.LOW]:		{min: 2.75*FRAME_RATE, max: 3.25*FRAME_RATE}, //100
		[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.LOWER]:	{min: 1.25*FRAME_RATE, max: 1.75*FRAME_RATE}, //200
		[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.MEDIUM]:	{min: 0.4*FRAME_RATE, max: 0.8*FRAME_RATE}, //~500
		[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.HIGH]:	{min: 0.3*FRAME_RATE, max: 0.5*FRAME_RATE} //~750
	},
...
const POOL_LIMITS = {
	[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.LOW]:		100,
	[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.LOWER]:	200,
	[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.MEDIUM]:	500,
	[GameProfilingInfo.i_VFX_LEVEL_PROFILE_VALUES.HIGH]:	750
};
