...
class MissEffectLevel1ExplosionAnimation extends Sprite
{
	...
	_startLight5()
	{
		...
		let lLight51_spr = this._fLight51_spr = this.addChild(APP.library.getSpriteFromAtlas('common/misty_flare'));
		...
		let lLight52_spr = this._fLight52_spr = this.addChild(APP.library.getSpriteFromAtlas('common/misty_flare'));
