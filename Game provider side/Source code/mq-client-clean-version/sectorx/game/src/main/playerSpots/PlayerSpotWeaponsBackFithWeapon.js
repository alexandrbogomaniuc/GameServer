...
class PlayerSpotWeaponsBackFithWeapon extends Sprite
{
	...
	_init()
	{
		...
		APP.profilingController.info.isVfxProfileValueMediumOrGreater && APP.currentWindow.on(GameScreen.DEFAULT_GUN_SHOW_FIRE, this._onDefaultWeaponShowFire, this);
	}

	_addBack()
	{
		let lBack_spr = this.addChild(APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_5/weapon_spot_back"));
	}

	_addGlow()
	{
		this._fGlow_spr = this.addChild(APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_5/weapon_spot_back_glow"));
		...
		this._fShotGlow_spr = this.addChild(APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_5/weapon_spot_back_glow"));
	...
	destroy()
	{
		...
		APP.currentWindow.off(GameScreen.DEFAULT_GUN_SHOW_FIRE, this._onDefaultWeaponShowFire, this);
