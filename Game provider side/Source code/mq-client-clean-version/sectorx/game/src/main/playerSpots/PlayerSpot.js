...
class PlayerSpot extends Sprite
{
	...
	_updateWeaponBack(aCurrentDefaultWeaponId_int)
	{
		...
		{
			case 4:
				this._fWeaponBack_spr = this._fWeaponBackContainer_spr.addChild(APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_4/turret_back"));
				break;
			case 5:
				this._fWeaponBack_spr = this._fWeaponBackContainer_spr.addChild(APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_5/turret_back"));
				break;
		}
	...
	_addNickname()
	{
		let lNickname_tf = this._nickname_tf =  this.addChild(new TextField(this._nicknameStyle));
		lNickname_tf.text = this._fPlayer_obj.nickname;
		lNickname_tf.anchor.set(0.5, 0.5);
		lNickname_tf.position.set(-24.5, -5);
