...
class Turret3FireEffect extends Sprite
{
	...
	constructor()
	{
		...
		//DUST HORISONTAL...
		let l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_3/dust");
		...
		//DUST VERTICAL...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_3/dust");
		...
		//CIRCLE...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_3/circle");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
		...
		lHitBoom_spr.position.y = -130;
		lHitBoom_spr.scale.set(2.692, 2.474); //1.346 * 2, 1.237 * 2
		lHitBoom_spr.tint = 0xb70f1a;
		...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_3/chainmuzzle");
		l_s.rotation = 1.4486232791552935; //Utils.gradToRad(83);
		//l_s.position.set(-12, 13);
		l_s.position.set(-17, 26);
		...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_3/chainmuzzle");
		l_s.rotation = 1.4486232791552935; //Utils.gradToRad(83);
		//l_s.position.set(-2, 5);
		l_s.position.set(-2, 22);
		l_s.position.alpha = 0.99
		l_s.scale.set(0.358, 0.194);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		this._fChaineMuzzle_s = this._fChaineMuzzleContainer_spr.addChild(l_s);
		...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/default_turret_3/chainmuzzle");
		l_s.rotation = 1.4486232791552935; //Utils.gradToRad(83);
		//l_s.position.set(9, 13);
		l_s.position.set(13, 26);
		l_s.position.alpha = 0.99
		l_s.scale.set(0.358, 0.194);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		this._fChaineMuzzle_s = this._fChaineMuzzleContainer_spr.addChild(l_s);
...
/* 	keyDownHandler(event)

			{
              ...
              switch (event.keyCode) {
                case 38:
                  this._fChaineMuzzle_s.position.y -= moveAmount;
                ...
                case 37:
                  this._fChaineMuzzle_s.position.x -= moveAmount;
              ...
              console.log(
                `Position: x = ${this._fChaineMuzzle_s.position.x}, y = ${this._fChaineMuzzle_s.position.y}`
              );
            } */
}
