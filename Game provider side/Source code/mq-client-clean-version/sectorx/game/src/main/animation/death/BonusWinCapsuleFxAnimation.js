...
class BonusWinCapsuleFxAnimation extends DeathFxAnimation
{
	...
	{
		this._fFlare_spr = this.addChild(APP.library.getSpriteFromAtlas("common/misty_flare"));
	...
	{
		this._fLight_spr = this.addChild(APP.library.getSpriteFromAtlas("common/light_particle"));
