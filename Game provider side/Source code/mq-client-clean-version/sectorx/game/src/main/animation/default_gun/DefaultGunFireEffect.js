...
class DefaultGunFireEffect extends Sprite 
{
	...
	_getFireEffectPosition()
	{
		...
		{
			case 1:
				lFireEffectPosition_obj = {x: 1, y: 170 + this._fWeaponOffsetYFiringContinuously_int};
				break;
			case 2:
				lFireEffectPosition_obj = {x: 1, y: 152 + this._fWeaponOffsetYFiringContinuously_int};
				break;
			case 3:
				lFireEffectPosition_obj = {x: 2, y: 148 + this._fWeaponOffsetYFiringContinuously_int};
				break;
			case 4:
	...
	destroy()
	{
		this._fFireAnimation_spr && this._fFireAnimation_spr.destroy();
		this._fFireAnimation_spr = null;
