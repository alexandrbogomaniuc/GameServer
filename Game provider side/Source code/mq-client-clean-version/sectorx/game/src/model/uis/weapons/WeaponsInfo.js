...
class WeaponsInfo extends SimpleInfo {
	...
	i_getNextWeaponIdToShoot()
	{
		...
		if(
			...
			APP.gameScreen &&
			APP.gameScreen.gameFieldController &&
			APP.gameScreen.gameFieldController.spot
			)
		{
			let lSuggestedBattlegroundFreeWeaponId_int = APP.gameScreen.gameFieldController.spot.getNextSuggestedBattlegroundFreeWeaponId();
