...
class RicochetController extends SimpleController
{
	...
	__initControlLevel()
	{
		...
		APP.gameScreen.fireController.on(FireController.EVENT_ON_RICOCHET_BULLET_FLY_OUT, this._onBulletFlyOut, this);
		APP.gameScreen.fireController.on(FireController.EVENT_ON_CLEAR_BULLETS_BY_SEAT_ID, this._onClearBulletsBySeatId, this);
		APP.gameScreen.fireController.on(FireController.EVENT_ON_BULLET_PLACE_NOT_ALLOWED, this._onBulletPlaceNotAllowed, this);
		...
		APP.gameScreen.playersSpotsController.on(PlayerSpotsController.EVENT_ON_MASTER_SEAT_ADDED, this._onMasterSeatAdded, this);
	}
	...
	_getNewPointToMoveFromCollision(startPoint, currentPoint, hitPoints)
	{
		...
		if (p1 && p2)
		{
			...
			// let mapContainer = APP.gameScreen.gameFieldController.screenField;
			...
			while (a < 0) a+= DOUBLE_PI;
			while (a >= DOUBLE_PI) a-= DOUBLE_PI;
	...
	destroy()
	{
		APP.gameScreen.fireController.off(FireController.EVENT_ON_RICOCHET_BULLET_FLY_OUT, this._onBulletFlyOut, this);
		APP.gameScreen.gameFieldController.off(GameFieldController.EVENT_ON_CLEAR_ROOM_STARTED, this._onRoomClear, this);
		APP.gameScreen.fireController.off(FireController.EVENT_ON_CLEAR_BULLETS_BY_SEAT_ID, this._onClearBulletsBySeatId, this);
		APP.gameScreen.fireController.off(FireController.EVENT_ON_BULLET_PLACE_NOT_ALLOWED, this._onBulletPlaceNotAllowed, this);
		...
		APP.gameScreen.off(GameScreen.EVENT_ON_BET_LEVEL_CHANGE_CONFIRMED, this._onBetLevelChangeConfirmed, this);

		APP.gameScreen.playersSpotsController.off(PlayerSpotsController.EVENT_ON_MASTER_SEAT_ADDED, this._onMasterSeatAdded, this);
