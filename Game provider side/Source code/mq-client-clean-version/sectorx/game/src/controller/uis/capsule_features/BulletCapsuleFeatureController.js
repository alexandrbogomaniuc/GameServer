...
class BulletCapsuleFeatureController extends SimpleUIController
{
	...
	static get EVENT_ON_ALL_ANIMATIONS_COMPLETED()	{ return BulletCapsuleFeatureView.EVENT_ON_ALL_ANIMATIONS_COMPLETED; }
	...
	__initViewLevel()
	{
		...
		this.view.on(BulletCapsuleFeatureView.EVENT_ON_ALL_ANIMATIONS_COMPLETED, this.emit, this);
	}
