...
class CursorController extends SimpleController
{
	...
	__init()
	{
		...
		this._gameScreen.fireController.on(FireController.EVENT_TIME_TO_VALIDATE_CURSOR, this._onTimeToValidateCursor, this);
		this._gameScreen.fireController.on(FireController.EVENT_ON_STOP_UPDATE_CURSOR_POSITION, this._onStopUpdatePosition, this);
		this._gameScreen.fireController.on(FireController.EVENT_ON_START_UPDATE_CURSOR_POSITION, this._onStartUpdatePosition, this);
		this._gameScreen.fireController.on(FireController.EVENT_ON_SET_SPECIFIC_CURSOR_POSITION, this._onSetSpecificPosition, this);
	...
	_validateCursor()
	{
		...
		if (	this._fGameStateInfo_gsi.gameState == ROUND_STATE.PLAY
				...
				&& this._gameField.view.interactive
