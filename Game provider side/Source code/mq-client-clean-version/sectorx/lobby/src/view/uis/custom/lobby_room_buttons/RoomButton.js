...
import { FRAME_RATE } from '../../../../../../../common/PIXI/src/dgphoenix/unified/controller/time/Ticker';
...
class RoomButtom extends GUSLobbyRoomButton
{
	...
	_initButton(aSkinId_int)
	{
		...
		l_btn.scale.set(0.95,0.95);

		if (
				(aSkinId_int == 5 || aSkinId_int == 3) &&
	...
	_mouseOut()
	{
		this._fButton_b.scaleTo(0.95, 1*FRAME_RATE);
	}
