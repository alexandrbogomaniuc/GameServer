...
<script type="text/javascript">
	...
	const WEAPONS_ARRAY = [
		...
		{betLevel: 5,	 weaponID: WEAPONS.DEFAULT}, //turret 3
		{betLevel: 10,	 weaponID: WEAPONS.DEFAULT}, //turret 4
		{betLevel: 20,	 weaponID: WEAPONS.DEFAULT} //turret 5
	];
			...
			_addWeapons()
			{
				for (let i = 0; i < WEAPONS_ARRAY.length; i++)
				{
					...
					Object.assign(lWeaponName.style, {
								...
								letterSpacing: "0px",
								transform: "translate(-175%, -50%) scale(1, 1)",
								opacity: "0", 
								left: "0px"
							});
						}
			...
			_getWeaponConfig(aWeaponId_num, aBetLevel)
			{
				...
				switch(aWeaponId_num)
				{
					case -1:
						switch(aBetLevel)
						{
							case 1:			return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_1", top: -25, left: 7, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
							case 2:			return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_2", top: -25, left: -1, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
							case 5:			return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_3", top: -25, left: -4, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
							case 10:			return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_4", top: -25, left: -5, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
							case 20:		return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_5", top: -45, left: -23, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
						}
