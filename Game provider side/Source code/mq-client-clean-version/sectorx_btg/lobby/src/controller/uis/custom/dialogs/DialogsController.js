...
class DialogsController extends SimpleUIController
{
	...
	{
		console.log("DialogsController:__generateDialogController " + dialogInfo.dialogId + " and the one we want is " + DialogsInfo.DIALOG_ID_BATTLEGROUND_CAF_ROOM_MANAGER)
	...
	{
		console.log("DialogsController:_updateDialogForPresentationSettings")
