...
class LobbyRoomButtons extends Sprite
{
	...
	_update(aStakes_num_arr)
	{
		...
		this._fRoomButtonsContainer.position.x = -RoomButton.INIT_X - RoomButton.VISIBLE_OFFSET_X * (Math.min(this._fStakesAmount_int, RoomButton.VISIBLE_AMOUNT) - 1) / 2 -169; // -169 === Center correction for new lobby
