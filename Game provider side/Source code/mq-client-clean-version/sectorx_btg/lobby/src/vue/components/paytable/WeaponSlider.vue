				...
				switch(aWeaponId_num)
				{
					case -1:
						switch(aBetLevel)
						{
							...
							case 3:			return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_3", top: -25, left: -4, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
							case 5:			return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_4", top: -25, left: -5, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
							case 10:		return {src: "paytable/pages/enemies/weapon_slider/weapons/turret_5", top: -45, left: -23, ctaAssetID: "TAPaytableEnemiesWeaponsTurret"};
						}
