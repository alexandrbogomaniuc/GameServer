...
class WeaponAwardingPointFx extends Sprite {
    ...
    _addFlare(x, y, maxScale)
    {
    	...
    	lFlare_sprt.rotation = 0.04537856055185257; //Utils.gradToRad(2.6);
    	lFlare_sprt.rotateTo(0.5689773361501514, 16 * FRAME_RATE); //Utils.gradToRad(32.6)
    }

    _addSmoke(x, y)
	{
		this._fSmoke_sprt = this.addChild(APP.library.getSpriteFromAtlas('blend/smoke'));
