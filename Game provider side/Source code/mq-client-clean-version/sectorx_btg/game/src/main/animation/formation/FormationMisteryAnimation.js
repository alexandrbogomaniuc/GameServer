...
class FormationMisteryAnimation extends Sprite
{
	...
	{
		let lLightParticlePurple_spr = this._fLightParticlePurple_spr = this.addChild(APP.library.getSprite("enemies/money/hit/light_particle_purple"));
	...
	_startLight8()
	{
		let lLight8_spr = this._fLight8_spr = this.addChild(APP.library.getSprite("enemies/money/mistery/light8"));
		lLight8_spr.aplha = 0;
