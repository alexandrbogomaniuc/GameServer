...
class PlayerSpotWeaponsBack extends Sprite
{
	...
	_getWeaponSpotBack(aWeaponid_num, aCurrentDefaultWeaponId_num)
	{
		...
		let lAssetName_str = "player_spot/ps_player_spot/player_spot_atlas";
		...
		if (lSpecViewType_int !== undefined)
		{
			...
			{
				case 1:
					lAssetName_str = "weapons/DefaultGun/default_turret_1/weapon_spot_back";
				break;
				case 2:
					lAssetName_str = "weapons/DefaultGun/default_turret_2/weapon_spot_back";
				break;
				case 3:
					lAssetName_str = "weapons/DefaultGun/default_turret_3/weapon_spot_back";
				break;
				case 4:
					lAssetName_str = "weapons/DefaultGun/default_turret_4/weapon_spot_back";
				break;
				case 5:
					lAssetName_str = "weapons/DefaultGun/default_turret_5/weapon_spot_back";
					break;
				default:
