...
import { Easing } from '../../../../../common/PIXI/src/dgphoenix/unified/model/display/animation/easing';
import { Sequence, PathTween } from '../../../../../common/PIXI/src/dgphoenix/unified/controller/animation';
...
class FreeShotsCounterView extends Sprite {
	...
	i_startFlying(aStartPos_pt)
	{
		...
		this.rotation = -0.582939970166106; //Utils.gradToRad(-8.4 - 25);
		...
		let rotationSequence = [
			...
			{
				tweens: [{ prop: "rotation", to: -0.059341194567807204}], //Utils.gradToRad(21.6 - 25)
				duration: FRAME_RATE*14
			},
			{
				tweens: [{ prop: "rotation", to: 0.25830872929516074}], //Utils.gradToRad(39.8 - 25)
