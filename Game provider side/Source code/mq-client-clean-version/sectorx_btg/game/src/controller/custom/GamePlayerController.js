...
import GameFieldController from '../uis/game_field/GameFieldController';
...
class GamePlayerController extends PlayerController
{
	...
	_onGameStarted(event)
	{
		...
		let lBattlegroundTutorialController_btc = this._fBattlegroundTutorialController_btc = APP.gameScreen.battlegroundTutorialController;
