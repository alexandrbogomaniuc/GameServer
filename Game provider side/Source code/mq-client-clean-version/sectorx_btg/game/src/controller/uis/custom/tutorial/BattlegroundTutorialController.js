...
class BattlegroundTutorialController extends SimpleUIController
{
	...
	__initControlLevel()
	{
		...
		let l_bcddc = APP.gameScreen.gameplayDialogsController.gameBattlegroundCountDownDialogController;
	...
	_showTutorialIfNeeded(aOptAutoHide_bl=false)
	{
		...
		let l_gf = APP.gameScreen.gameFieldController;
		let l_pi = APP.playerController.info;
		let l_gs = APP.gameScreen;
			...
			)
		{
			let l_obj = {
					...
					SWPanel: 			l_gs.scoreboardController.view.getBounds(),
					//dragonStonePanel: 	l_gf.fragmentsPanelController.view.getBounds(),
