...
class CalloutController extends SimpleUIController
{
	...
	__initControlLevel ()
	{
		...
		APP.gameScreen.subloadingController.on(SubloadingController.EVENT_ON_HIDE_LOADING_SCREEN, this.__validate, this);
	}
	...
	_updateCalloutPresentedState(aPresented_bl)
	{
		...
		if (APP.gameScreen.subloadingController.isLoadingScreenShown)
		{
			return;
		}
