...
class LightningCapsuleFeatureController extends SimpleUIController
{
	...
	static get EVENT_ON_TARGET_NOT_FOUND()				{ return LightningCapsuleFeatureView.EVENT_ON_TARGET_NOT_FOUND; }
	...
	__initViewLevel()
	{
		...
		this.view.on(LightningCapsuleFeatureView.EVENT_ON_TARGET_NOT_FOUND, this.emit, this);
	}
