...
{
	static get EVENT_ON_BET_MULTIPLIER_CHANGED() { return BattlegroundMainPlayerSpot.EVENT_ON_BET_MULTIPLIER_CHANGED; }
	...
	_addMasterPlayerSpot(player, aOptCurrentWeaponId_int = WEAPONS.DEFAULT)
	{
		...
		lMainPlayerSpot_s.on(BattlegroundMainPlayerSpot.EVENT_ON_BET_MULTIPLIER_CHANGED, this.emit, this);
		...
		lGameField_gf.spot.on(BattlegroundMainPlayerSpot.EVENT_ON_CHANGE_WEAPON_TO_DEFAULT_REQUIRED, this._onPlayerChangeWeaponToDefaultRequired, this);
		lGameField_gf.spot.on(BattlegroundMainPlayerSpot.EVENT_ON_ROTATE_GUN_TO_ZERO, this._onPlayerSpotRotateToZeroWeaponRequired, this);
		lGameField_gf.spot.on(BattlegroundMainPlayerSpot.EVENT_RELOAD_REQUIRED, this._onReloadRequired, this);

		APP.gameScreen.on(GameScreen.EVENT_ON_BET_LEVEL_CHANGE_CONFIRMED, this._onBetLevelChangeConfirmed, this);

		lGameField_gf.tryToChangeWeaponOnSpotAdded(aOptCurrentWeaponId_int);
	...
	_onBetLevelChangeConfirmed(aEvent_obj)
	{
		...
		else
		{
			...
			{
				console.log("FireProblem_ change weapon call 18");
	...
	_clearSpot()
	{
		APP.gameScreen.gameFieldController.spot.off(BattlegroundMainPlayerSpot.EVENT_RELOAD_REQUIRED, this._onReloadRequired, this);
		APP.gameScreen.gameFieldController.spot.off(BattlegroundMainPlayerSpot.EVENT_ON_ROTATE_GUN_TO_ZERO, this._onPlayerSpotRotateToZeroWeaponRequired, this);
	}
