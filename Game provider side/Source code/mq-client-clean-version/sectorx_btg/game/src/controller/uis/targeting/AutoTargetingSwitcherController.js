...
class AutoTargetingSwitcherController extends SimpleUIController {
	...
	_addViewIfRequired()
	{
		...
		this.view.i_addToContainerIfRequired(this._gameScreen.gameFieldController.autoTargetingSwitcherContainerInfo);
	}
	...
	_validate()
	{
		if (this._gameScreen && this._gameScreen.gameFieldController.isGameplayStarted())
		{
