...
class GameCafRoomManagerController extends SimpleController {
	...
	_startRoomManagerHandling() {
		...
		if (APP.gameScreen.gameFieldController && APP.gameScreen.gameFieldController.screenField) {
			this._startRoomManagerScreenMessagesHandling();
		}
		else {
			APP.gameScreen.gameFieldController.once(GameScreen.EVENT_ON_GAME_FIELD_SCREEN_CREATED, this._onGameFieldScreenCreated, this);
		}
	}
