...
class MoneyWheelController extends SimpleUIController
{
	...
	_onWinValueAnimationCompleted()
	{
		...
		{
			let lCurrentStake_num = (APP.isBattlegroundGame ? FIXED_BATTLEGOUND_STAKE : APP.playerController.info.currentStake);
			...
			let lRatio_num  = lHitData_obj.win / ((APP.isBattlegroundGame ? FIXED_BATTLEGOUND_STAKE : APP.playerController.info.currentStake) * lHitData_obj.betLevel)
