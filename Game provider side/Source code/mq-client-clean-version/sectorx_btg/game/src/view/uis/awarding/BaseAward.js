...
class BaseAward extends Sprite
{
	...
	showAwarding(aValue_num, aParams_obj)
	{
		...
		this._fSkipAwardAfterAnimation = false;
	...
	set isSkippingAwardAfterAnimation(aValue)
	{
		this._fSkipAwardAfterAnimation = aValue;
	}
 
	get isSkippingAwardAfterAnimation()
	{
		return this._fSkipAwardAfterAnimation;
	}
	...
	constructor(aGameField_sprt, aAwardType_int)
	{
		...
		this._fSkipAwardAfterAnimation = null;
	}
