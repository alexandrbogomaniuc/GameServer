...
class EarthBossCaptionView extends BossModeCaptionView
{
	...
	__startCaptionAnimation()
	{
		if (APP.profilingController.info.isVfxProfileValueMediumOrGreater)
		{
			this._fBacgroundGlow_spr = this.__fCaptionContainer_sprt.addChild(APP.library.getSprite("common/light_particle"));
	...
	_startMiniExplosion(aOptIsFinal_bl=false)
	{
		...
		this._fLightParticle_spr = this.addChild(APP.library.getSprite("common/light_particle"));
		...
		// LIGHT_5...
		this._fMistyLight_spr = this.addChild(APP.library.getSprite("common/misty_flare"));
	...
	_startBackgroundSmokesAnimation()
	{
		...
		{
			let l_spr = this.__fBackgroundContainer_sprt.addChild(APP.library.getSprite("boss_mode/earth/caption_background_smoke_screen"));
			l_spr.scale.set(2);
	...
	_startOrangeSmokes()
	{
		...
		let lFirstSmoke_spr = this.addChild(APP.library.getSprite("boss_mode/earth/smoke_orange"));
		...
		let lSecondSmoke_spr = this.addChild(APP.library.getSprite("boss_mode/earth/smoke_6"));
		...
		let lThirdSmoke_spr = this.addChild(APP.library.getSprite("boss_mode/earth/smoke_orange"));
