...
class BossModeView extends SimpleUIView
{
	...
	constructor()
	{
		...
		this._bossSequenceActive = false;
	...
	get isBossSequenceActive(){
		return this._bossSequenceActive;
	}

	set isBossSequenceActive(aValue_bool)
	{
		_this._bossSequenceActive = aValue_bool;
	}
