...
class LightningBossMiniExplosionAnimation extends Sprite
{
	...
	_startParticle()
	{
		let lParticle_spr = this._fLightnParticle_spr = this.addChild(APP.library.getSprite('common/light_particle'));
	...
	_startLight5()
	{
		let lLight5_spr = this._fLight5_spr = this.addChild(APP.library.getSprite('common/misty_flare'));
