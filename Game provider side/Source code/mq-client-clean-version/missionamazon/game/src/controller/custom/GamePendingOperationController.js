...
class GamePendingOperationController extends GUPendingOperationController {
	...
	__initControlLevel() {
		...
		// Accessing event name string directly to avoid circular dependency
		APP.gameScreen.on("EVENT_ON_BTG_ROUND_OBSERVER_DENIED", this._onBattlegroundRoundObserverDenied, this);
	...
	__startHandleServerMessages() {
		...
		wsInteractionController.on(WebSocketInteractionController.EVENT_ON_CONNECTION_READY_TO_ROOM_OPEN, this._onServerConnectionReadyToRoomOpen, this);
	}
