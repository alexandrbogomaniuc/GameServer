...
class InstantKillProjectile extends Sprite
{
	...
	shoot(distance)
	{
		...
		this.beamPlasma.scaleXTo(this.distance/this.beamPlasmaInitialWidth, 4*16.6, null, this.onScaleCompleted.bind(this), this.onScaleChange.bind(this));
		...
		this.beamWhite.scaleXTo(this.distance/this.beamWhiteInitialWidth, 4*16.6);
