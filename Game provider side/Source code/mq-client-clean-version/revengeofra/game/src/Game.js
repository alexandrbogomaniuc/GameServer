...
import GameTooltipsController from './controller/uis/custom/tooltips/GameTooltipsController';
...
class Game extends Application
{
	...
	{
		return ['preloader/mummy', 'preloader/smoke', 'preloader/sparks', 
				...
				'preloader/logo/logo_flare', 'preloader/logo/logo_smoke', 
				'TALobbyPreloaderLogoReturnOfRaGlow', 'TALobbyPreloaderLogoMaxQuestGlow', 'TALobbyPreloaderLogo'];
	}
	...
	_onTexturesInited()
	{
		this.loaderUI.resumeTooltips();

		if (this.browserSupportController.info.isAudioContextSuspended)
		{
	...
	{
		return this._fTooltipsController_gtc || (this._fTooltipsController_gtc = this._initTooltipsController());
	}

	_initTooltipsController()
	{
		let l_gtc = new GameTooltipsController();
		l_gtc.i_init();
		this._fTooltipsController_gtc = l_gtc;
	...
	onLobbyMessageReceived(event)
	{
		...
		console.log("onLobbyMessageReceived", msgType);
	...
	{
		this.externalCommunicator.sendExternalMessage(GAME_MESSAGES.ROUND_RESULT_RETURN_SW_RESPONSE, {weaponsReturned: event.weaponsReturned});
	}
