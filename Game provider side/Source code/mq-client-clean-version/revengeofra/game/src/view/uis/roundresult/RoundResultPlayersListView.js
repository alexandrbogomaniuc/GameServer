...
class RoundResultPlayersListView extends Sprite
{
	...
	_addRow(aPositionY_num, aId_num, aAlpha_num)
	{
		...
		let lGold_sprt = lRow_sprt.addChild(APP.library.getSprite('round_result/players_list/gold/coins_' + (aId_num > 4 ?  4 :  aId_num)));
	...
	{ 
		...
		lPlayerRowBack_grphc.beginFill(0xf6921e, 1).drawRoundedRect(-150, -15, 300, 30, 2.5);
