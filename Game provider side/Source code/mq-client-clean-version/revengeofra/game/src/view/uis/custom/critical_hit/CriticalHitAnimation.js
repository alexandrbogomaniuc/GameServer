...
class CriticalHitAnimation extends Sprite
{
	...
	constructor(aWin_num, aMult_num, aEnemyId_num, aEnemyName_str, aEnemyDirection_str, aRid_num, aMineId_str)
	{
		super();
		...
		this._fMineId_str = aMineId_str;
		this._fWin_num = aWin_num;
		this._fMult_num = aMult_num;
		this._fEnemyId_num = aEnemyId_num;
		this._fEnemyName_str = aEnemyName_str || ENEMIES.WrappedYellow;
	...
	{
		let lGlowFilter_cmf = new GlowFilter({distance: 8, outerStrength: 2.5, innerStrength: 2, color: 0xffffe6, quality: 2, padding: 4});
