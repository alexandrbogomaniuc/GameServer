...
class InstantKillAnimation extends Sprite
{
	...
	constructor(aIsMasterSeat_bl, aEnemyId_num)
	{
		super();
	...
	_animateExplosion()
	{
		...
		lExplosion_spr.once('animationend', () =>{
	...
	_animateCaption()
	{
		...
		let lCaptionAsset_str = this._fIsMasterSeat_bl ? "TAInstantWinLabel" : "TAInstantWinSilverLabel"
		lCaptionCountainer_spr.addChild(I18.generateNewCTranslatableAsset(lCaptionAsset_str))
		let lCaptionWhite_spr = lCaptionCountainer_spr.addChild(I18.generateNewCTranslatableAsset("TAInstantWinWhiteLabel"));
