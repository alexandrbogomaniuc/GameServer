...
class CryogunsView extends SimpleUIView {
	...
	i_showFire(aShotData_obj, aStartPos_pt, aEndPos_pt, aWeaponScale)
	{
		this._showFire(aShotData_obj, aStartPos_pt, aEndPos_pt, aWeaponScale)
	}
	...
	_showFire(aShotData_obj, aStartPos_pt, aEndPos_pt, aWeaponScale)
	{
		//DEBUG...
		// let gr = new PIXI.Graphics();
		...
		let lBeam_cb = new CryogunBeam(aShotData_obj);
	...
	{
		this._startCentralEffect(aEvent_obj.x, aEvent_obj.y);
	}
