...
class CryogunsController extends SimpleUIController {
	...
	static get WEAPON_ACTION_RADIUS()									{ return 250; } //280 is on server + some delta for inaccuracy
	...
	_showFire(data)
	{
		...
		//let lEndPos_pt = CryogunsController.CENTER_TARGET_POINT;
		let lEndPos_pt = new PIXI.Point(data.x, data.y); //this._gameScreen.gameField.lastPointerPos;
		...
		this.view.i_showFire(data, lStartPos_pt, lEndPos_pt, weaponScale);
	}
