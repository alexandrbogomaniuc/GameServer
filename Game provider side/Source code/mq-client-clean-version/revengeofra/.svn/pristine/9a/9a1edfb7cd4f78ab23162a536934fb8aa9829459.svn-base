...
class DeathFxAnimation extends Sprite
{
	...
	_playIntro(aIsFastVariant_bl = false, aSkipOutro_bl = false)
	{
		...
		var outroSequence = [{	tweens: [],
								duration: (aIsFastVariant_bl ? 10 : 68)*2*16.6,
								onfinish: () => {this._playOutro(aSkipOutro_bl);}
		}];
...
DeathFxAnimation.EVENT_ANIMATION_COMPLETED = "EVENT_ANIMATION_COMPLETED";
DeathFxAnimation.EVENT_OUTRO_STARTED = "EVENT_OUTRO_STARTED";
