...
const MAXIMUM_MINE_EXPLOSION_NUMBER = 10;
...
class GameOptimizationInfo extends SimpleInfo {
	constructor()
	{
		...
		this._fCurrentMineExplosionsNumber_int = 0;
		...
		this._fMoneyWheel_num = 0;
	}

	get currentMineExplosionsNumber()
	{
		return this._fCurrentMineExplosionsNumber_int;
	}
	...
	i_increaseMineExplosionsNumber()
	{
		this._fCurrentMineExplosionsNumber_int++;
	}

	i_decreaseMineExplosionsNumber()
	{
		this._fCurrentMineExplosionsNumber_int > 0 && this._fCurrentMineExplosionsNumber_int--;
	}
	...
	i_isMineExplosionsMaximumExceed()
	{
		return this.currentMineExplosionsNumber >= MAXIMUM_MINE_EXPLOSION_NUMBER;
	}
	...
	//money wheel...
	i_increaseCurrentMoneyWheelAmount()
	{
		this._fMoneyWheel_num++;
	}

	i_decreaseCurrentMoneyWheelAmount()
	{
		this._fMoneyWheel_num > 0 && this._fMoneyWheel_num--;
	}

	get currentCurrentMoneyWheelAmount()
	{
		return this._fMoneyWheel_num;
	}
	//...money wheel
