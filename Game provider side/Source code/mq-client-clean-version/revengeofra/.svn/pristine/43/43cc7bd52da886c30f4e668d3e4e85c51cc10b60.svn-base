...
class GameRoundResultReturnedSWDialogController extends GameBaseDialogController
{
	...
	constructor(aOptInfo_usuii, parentController)
	{
		...
		this._initGameRoundResultReturnedSWDialogController();
	}

	_initGameRoundResultReturnedSWDialogController()
	{
	}

	__getExternalViewForSelfInitialization()
	{
		return this.__getViewLevelSelfInitializationViewProvider().roundResultReturnedSWDialogView;
	}
	...
	__validateViewLevel ()
	{
		...
		if (info.isActive)
		{
			...
			view.setMessage("TADialogReturnUnexplodedMinesInfo");
			view.setOkMode();
			//...message configuration
		}
	...
	_onRoundResultResponse(data)
	{
		let lDataWeaponsReturned_arr = data.weaponsReturned;
...
export default GameRoundResultReturnedSWDialogController