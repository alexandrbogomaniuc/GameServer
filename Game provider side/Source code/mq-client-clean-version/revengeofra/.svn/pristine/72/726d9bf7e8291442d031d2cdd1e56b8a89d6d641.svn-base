...
class GrenadeEffectsAnimation extends Sprite {
	...
	_addGlow2() {
		let glow2 = this.addChild(APP.library.getSprite('weapons/GrenadeGun/crate_glow_ring'));
		glow2.zIndex = 100-6;
	...
	_addFireblast() {
		...
		let fireblast = this.addChild(APP.library.getSprite('weapons/GrenadeGun/MQ_Grenade_Fireblast_ADD'));
	...
	_addDimmer() {
		let dimmer = this.addChild(APP.library.getSprite('weapons/GrenadeGun/dimmer'));
	...
	_addPillar(params, container) {
		let pillar = container.addChild(APP.library.getSprite('weapons/GrenadeGun/MQ_Grenade_BlackSmokePillar'));
	...
	_addSparks(container) {
		...
		let texture = APP.library.getSprite('common/spark').textures[0];
