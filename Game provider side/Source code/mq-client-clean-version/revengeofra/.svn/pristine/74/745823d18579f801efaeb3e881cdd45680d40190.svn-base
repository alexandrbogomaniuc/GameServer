...
{	
	...
	get MOBILE_TOOLTIP_TEXT()
	{
		return {
			0:	"TAPreloaderTip0",
			1:  "TAPreloaderMobileTip1",
			2:	"TAPreloaderTip2",
			3:	"TAPreloaderMobileTip3",};
	}

	get ELLIPSE_CONFIGS()
	{
		return {
			0: {src: "preloader/tips/ellipse_tip_0", x: 14, y: 86},
			1: null,
			2: {src: "preloader/tips/ellipse_tip_2", x: -122, y: 2},
			3: null
		}
	}
	...
	_addContent()
	{
		...
		tooltipText.position.set(0, 150);
	}
