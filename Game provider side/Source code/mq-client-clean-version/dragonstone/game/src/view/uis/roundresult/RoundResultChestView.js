...
const TREASURE_ASSETS = [
	...
	{ id: 8, asset: "round_result/effect/glow_1" },
	{ id: 9, asset: "round_result/effect/glow_2" },
	{ id: 10, asset: "round_result/effect/glow_3" },
	{ id: 11, asset: "round_result/effect/glow_4" },
	{ id: 12, asset: "round_result/effect/glow_5" },
	{ id: 13, asset: "round_result/effect/sperkles" },
	{ id: 14, asset: "round_result/chest/back" }
];

const TREASURE_LAYER = [
	{ layer: 0, id: 14, position: { x: 0, y: 10.5 }, alpha: 1, addMode: false, delay: 0 * FRAME_RATE, duration: 107 * FRAME_RATE },
	{ layer: 1, id: 1, position: { x: -1.5, y: 17.5 }, alpha: 1, addMode: false, delay: 24 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 2, id: 2, position: { x: 31.5, y: 17.5 }, alpha: 1, addMode: false, delay: 59 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 3, id: 3, position: { x: -22.5, y: -3 }, alpha: 1, addMode: false, delay: 52 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 4, id: 7, position: { x: 4, y: 0.5 }, alpha: 1},
	{ layer: 5, id: 8, position: { x: -5.5, y: -13.5 }, alpha: 0.4, addMode: true, delay: 32 * FRAME_RATE, duration: 61 * FRAME_RATE },
	{ layer: 6, id: 9, position: { x: -5.5, y: -13.5 }, alpha: 0.4, addMode: true, delay: 39 * FRAME_RATE, duration: 73 * FRAME_RATE },
	{ layer: 7, id: 10, position: { x: -5.5, y: -11 }, alpha: 0.3, addMode: true, delay: 48 * FRAME_RATE, duration: 70 * FRAME_RATE },
	{ layer: 8, id: 13, position: { x: -5.5, y: -20 }, alpha: 1, addMode: true, delay: 54 * FRAME_RATE, duration: 74 * FRAME_RATE },
	{ layer: 9, id: 11, position: { x: -5.5, y: -10.5 }, alpha: 1, addMode: true, delay: 58 * FRAME_RATE, duration: 81 * FRAME_RATE },
	{ layer: 10, id: 4, position: { x: 31.5, y: 25.5 }, alpha: 1, addMode: true, delay: 59 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 11, id: 5, position: { x: 41.5, y: 17 }, alpha: 1, addMode: true, delay: 60 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 12, id: 4, position: { x: 34.5, y: 29.5 }, alpha: 1, addMode: true, delay: 34 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 13, id: 6, position: { x: -24, y: 25 }, alpha: 1, addMode: true, delay: 34 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 14, id: 4, position: { x: -44, y: 26.5 }, alpha: 1, addMode: false, delay: 51 * FRAME_RATE, duration: 23 * FRAME_RATE },
	{ layer: 15, id: 12, position: { x: -19.5, y: -8.5 }, alpha: 1, addMode: false, delay: 52 * FRAME_RATE, duration: 23 * FRAME_RATE }
];
...
class RoundResultChestView extends Sprite
{
	...
	_init()
	{
		...
		{
			let lTreasure_sprt = this._fChestCountainer_sprt.addChild(APP.library.getSpriteFromAtlas(TREASURE_ASSETS[TREASURE_LAYER[i].id - 1].asset));
		...
		{
			let lFlare_sprt = this._fChestCountainer_sprt.addChild(APP.library.getSpriteFromAtlas("round_result/chest/flare"));
	...
	_show()
	{
		if (this._fTreasure_spr_arr)
		{
			...
			{
				this._fTreasure_spr_arr[i].alpha = TREASURE_LAYER[i].alpha;
			}
	...
	_startTresureAnimation()
	{
		...
		for (let i = 0; i < this._fTreasure_spr_arr.length; i++)
		{
			...
			this._animate(this._fTreasure_spr_arr[i], TREASURE_LAYER[i].delay, TREASURE_LAYER[i].duration, TREASURE_LAYER[i].alpha, lIsLast_bl)
		}
	}
	...
	_animate(aTreasure_sprt, aDelay_num, aDuration_num, aAlpha_num, aIsLast_bl)
	{
		let sequenceVisible = [
			{
				tweens: [],
