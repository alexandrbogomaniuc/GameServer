...
class CharcoalFlyingDebris extends FlyingDebris {
	...
	addFire(){
		...
		this._fRedSprite_sprt = APP.library.getSpriteFromAtlas('weapons/MineLauncher/minelauncher_debris/charcoal_red_' + n);
	...
	{
		let n = this._getRandomAssetIndex();
		let lDebrisSprite_sprt = APP.library.getSpriteFromAtlas('weapons/MineLauncher/minelauncher_debris/charcoal_' + n);
