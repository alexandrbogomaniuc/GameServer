...
class MissEffectLevel3 extends MissEffect
{
	...
	init()
	{
		...
		//CIRCLE...
		l_s = APP.library.getSpriteFromAtlas("enemy_impact/circle_blast/circle_blast_3");
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
		...
		//RAY...
		l_s = APP.library.getSpriteFromAtlas("enemy_impact/circle_blast/sparkle_blue");
		...
		//EXPLOSION...
		l_s = APP.library.getSpriteFromAtlas("enemy_impact/explosion/explosion_3");
		l_s.scale.set(0);
		l_s.position.set(10, 20);
