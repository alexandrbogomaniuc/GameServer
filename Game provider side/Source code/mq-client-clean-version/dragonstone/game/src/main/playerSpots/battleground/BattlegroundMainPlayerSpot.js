...
class BattlegroundMainPlayerSpot extends PlayerSpot
{
	...
	_addAmmoValue()
	{
		...
		l_ta.position.set(lX_num, lY_num - 10);
	}
	...
	*/
	...
	_addBack()
	{
		this._fBack_sprt = this.getBackgroundSprite().addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/back"));
	...
	_addGunLevelIndicator()
	{
		...
		for( let i = 0; i < 3; i++ )
		{
			let l_s = this.getBackgroundSprite().addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/gun_level_" + i));
		...
		//STAR...
		let lStar_s = this.getBackgroundSprite().addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/star"));
		...
		for( let i = 0; i < 3; i++ )
		{
			let l_s = this.getBackgroundSprite().addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/arrow"));
