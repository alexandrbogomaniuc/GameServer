...
class CryogunBeam extends WeaponBeam
{
	...
	__shoot(aStartPoint_pt, aEndPoint_pt)
	{
		...
		{
			let lBeamDimmer_sprt = APP.library.getSpriteFromAtlas('weapons/Cryogun/beam_dimmer');
	...
	{
		let lParticlesPiece_sprt = APP.library.getSpriteFromAtlas('weapons/Cryogun/particles');
