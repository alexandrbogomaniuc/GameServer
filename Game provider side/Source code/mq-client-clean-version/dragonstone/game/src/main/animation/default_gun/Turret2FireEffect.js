...
class Turret2FireEffect extends Sprite
{
	...
	constructor()
	{
		...
		//DUST HORISONTAL...
		let l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_2/dg_fx_2/dust");
		...
		//DUST VERTICAL...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_2/dg_fx_2/dust");
		...
		//SPARKLES...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_2/dg_fx_2/sparkles");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.alpha = 0;
		...
		//CIRCLE...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_2/dg_fx_2/circle");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
		...
		//FLASH...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_2/dg_fx_2/flash");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
