...
class Cryogun extends Gun {
	...
	constructor(aIsMaster_bl, aPlayChargeSoundOnCreate_bl = true)
	{
		super();
		...
		this._fPlayChargeSound_bl = aPlayChargeSoundOnCreate_bl;
		this._createView();
		this.reload();
		this._fPlayChargeSound_bl = true;
	}
	...
	_createView()
	{
		let lCryogun_sprt = this.addChild(APP.library.getSpriteFromAtlas('weapons/Cryogun/cryogun'));
	}
	...
	_initReloadState()
	{
		...
		let lFrozenCryogun_sprt = this._fReloadCover_sprt.addChild(APP.library.getSpriteFromAtlas('weapons/Cryogun/cryogun_frozen'));
		lFrozenCryogun_sprt.alpha = 0;
		lFrozenCryogun_sprt.fadeTo(1, 8*2*16.7);

		let lFreezeOver_sprt = this._fReloadCover_sprt.addChild(APP.library.getSpriteFromAtlas('weapons/Cryogun/cryogun_freeze_over'));
