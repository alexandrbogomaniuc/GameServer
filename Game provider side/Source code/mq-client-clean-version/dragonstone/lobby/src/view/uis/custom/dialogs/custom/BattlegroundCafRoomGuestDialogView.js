...
class BattlegrBattlegroundCafRoomGuestDialogView extends DialogView {
	...
	validatePlayersListView() {
		this._fPlayersListView_bpplv.update(this.uiInfo.playersListData);
	}
	...
	_addDialogBase() {
		...
		onlineFriendsLabel.position.set(-240, 10);
	...
	_onInputBlur() {
		...
		console.log("blur get value " + lValue_str.length);
...
export default BattlegrBattlegroundCafRoomGuestDialogView;