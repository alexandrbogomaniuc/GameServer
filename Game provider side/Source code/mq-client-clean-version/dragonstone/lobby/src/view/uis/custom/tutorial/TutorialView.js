...
class TutorialView extends SimpleUIView
{
	...
	__prepareLines(aData_obj)
	{
		...
		lHint_obj = {
			...
			points: [
				{ x: lSWBounds_obj.x + 40, y: lSWBounds_obj.y, dot: true},
				{ x: lSWBounds_obj.x + 40, y: lSWBounds_obj.y - 10, dot: false},
				{ x: lSWBounds_obj.x + lSWBounds_obj.width/2 + 10, y: lSWBounds_obj.y - 10, dot: false},
				{ x: lSWBounds_obj.x + lSWBounds_obj.width/2 + 10, y: lSWBounds_obj.y + lSWBounds_obj.height + 10, dot: false},
				{ x: lSWBounds_obj.x + 40, y: lSWBounds_obj.y + lSWBounds_obj.height + 10, dot: false},
				{ x: lSWBounds_obj.x + 40, y: lSWBounds_obj.y + lSWBounds_obj.height, dot: true},
		...
		let lDSPanelBounds_obj = aData_obj.dragonStonePanel;
		let lDSPanelStartPosition_obj = {
			x: lDSPanelBounds_obj.x + lDSPanelBounds_obj.width/2 - 20,
			y: APP.isMobile ? lDSPanelBounds_obj.y + lDSPanelBounds_obj.height/4 + 170: lDSPanelBounds_obj.y + lDSPanelBounds_obj.height/2
		};
		//SUMMON DRAGON...
		lHint_obj = {
			...
			textPosition:
			{
				...
				y: lDSPanelStartPosition_obj.y + 10
			},
			points: [
				{ x: lDSPanelStartPosition_obj.x, y: lDSPanelStartPosition_obj.y, dot: true},
				{ x: lDSPanelStartPosition_obj.x - 200, y: lDSPanelStartPosition_obj.y, dot: false}
			]
		};
