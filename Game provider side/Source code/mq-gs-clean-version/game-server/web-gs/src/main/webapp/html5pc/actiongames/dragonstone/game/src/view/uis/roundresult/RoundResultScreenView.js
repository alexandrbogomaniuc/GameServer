...
class RoundResultScreenView extends SimpleUIView
{
	...
	_addBack()
	{
		let lBack_spr = this.addChild(APP.library.getSprite("round_result/rr_round_result/back"));

		let lIcon_spr = this.addChild(APP.library.getSpriteFromAtlas("round_result/rr_round_result/icon"));
	...
	_addBackLines()
	{
		...
		let lFrame_sprt = this.addChild(APP.library.getSpriteFromAtlas('round_result/rr_round_result/frame'));
	...
	{
		let lLine_spr = this.addChild(APP.library.getSpriteFromAtlas("round_result/rr_round_result/line"));
	...
	_addGraphics()
	{
		...
		this._fChest_rrcv.position.set(-86.5, -68);
	...
	_showNextButton()
	{
		...
		{
			let lNextRoundButton_btn = this._nextRoundBtn = this.addChild(new RoundResultButton("round_result/rr_round_result/active_btn", "round_result/rr_round_result/deactive_btn", "TARoundResultNextRoundBtnCaption", false, undefined, RoundResultButton.BUTTON_TYPE_ACCEPT));
