...
class FlyingDebris extends Bullet {
	...
	_initBaseSprite()
	{
		...
		let lDebrisSprite_sprt = APP.library.getSpriteFromAtlas('weapons/grenadegun_debris/debris_' + n);
	...
	_prepareForFinalRebound()
	{
		...
		this.endPos.x = this.endPos.x + currentFootPoint.x - Math.cos(this._bulletAngle)*LAST_OFFSET_DIST;
		this.endPos.y = this.endPos.y + currentFootPoint.y + Math.sin(this._bulletAngle)*LAST_OFFSET_DIST;
	...
	_startFinalRebound()
	{
		this.endPos.x = this.endPos.x - Math.cos(this._bulletAngle)*LAST_OFFSET_DIST;
		this.endPos.y = this.endPos.y + Math.sin(this._bulletAngle)*LAST_OFFSET_DIST;
