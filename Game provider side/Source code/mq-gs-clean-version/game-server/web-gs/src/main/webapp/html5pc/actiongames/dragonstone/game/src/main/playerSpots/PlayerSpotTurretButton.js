...
class PlayerSpotTurretButton extends PointerSprite
{
	...
	_init()
	{
		...
		let lArrow_sprt = this._fArrow_sprt = this.addChild(APP.library.getSpriteFromAtlas("weapons/sidebar/sb_sidebar/back_arrow"));
	...
	_invalidateBoby()
	{
		...
		{
			let lTurretIcon_sprt = this._fBody_sprt.addChild(APP.library.getSpriteFromAtlas("player_spot/ps_player_spot/turret_icon"));
