...
class BattlegroundController extends SimpleController
{
	...
	_onGameMessageReceived(event)
	{
		...
		switch (msgType)
		{
			...
			case GAME_MESSAGES.SERVER_ERROR_MESSAGE_RECIEVED:
				if (event.data.errorCode === LobbyWebSocketInteractionController.ERROR_CODES.BUYIN_NOT_ALLOWED_AT_CURRENT_GAME_STATE || event.data.errorCode === LobbyWebSocketInteractionController.ERROR_CODES.NOT_ALLOWED_SITIN)
				{
	...
	_onServerEnterLobbyMessage(event)
	{
		...
		let l_bbicdc = APP.dialogsController.battlegroundBuyInConfirmationDialogController;
		let l_bbicdcCAF = APP.dialogsController.battlegroundBuyInConfirmationDialogControllerCAF;
		...
		l_bbicdcCAF.on(BattlegroundBuyInConfirmationDialogControllerCAF.EVENT_BATTLEGROUND_RE_BUY_CONFIRMED, this._onBattlegroundBuyInConfirmed, this);
		l_bbicdcCAF.on(BattlegroundBuyInConfirmationDialogControllerCAF.EVENT_BATTLEGROUND_BUY_IN_CONFIRMED, this._onBattlegroundBuyInConfirmed, this);
