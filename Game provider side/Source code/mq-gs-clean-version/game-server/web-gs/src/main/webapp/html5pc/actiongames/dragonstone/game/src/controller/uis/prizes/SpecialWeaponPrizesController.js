...
class SpecialWeaponPrizesController extends SimpleController {
	...
	_onTimeToShowSpecialWeaponPrize(event)
	{
		...
		let lNextBetLevel_int = event.nextBetLevel;

		this._handleSpecialWeaponPrize(lSpecialWeaponId_int, lNextBetLevel_int, lSeatId_int, lStartPosition_pt);
	}

	_handleSpecialWeaponPrize(aSpecialWeaponId_int, aNextBetLevel_int, aSeatId_int, aStartPosition_pt)
	{
		let lSpecialWeaponPrizeController_swpc = new SpecialWeaponPrizeController(this._fUniqueCounter_int++, aSpecialWeaponId_int, aNextBetLevel_int, aSeatId_int, aStartPosition_pt);
