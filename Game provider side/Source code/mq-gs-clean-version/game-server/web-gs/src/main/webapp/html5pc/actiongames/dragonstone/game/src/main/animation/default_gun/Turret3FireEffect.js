...
class Turret3FireEffect extends Sprite
{
	...
	constructor()
	{
		...
		//DUST HORISONTAL...
		let l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_3/dg_fx_3/dust");
		...
		//DUST VERTICAL...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_3/dg_fx_3/dust");
		...
		//SPARKLES...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_3/dg_fx_3/sparkles");
		...
		//CIRCLE...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_3/dg_fx_3/circle");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
		...
		//FLASH...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_3/dg_fx_3/flash");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
