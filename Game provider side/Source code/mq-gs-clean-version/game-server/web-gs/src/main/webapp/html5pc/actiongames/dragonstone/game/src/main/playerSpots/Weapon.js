...
import Railgun from '../animation/railgun/Railgun';
...
{
	static get EVENT_ON_GUN_RELOADED() { return Railgun.EVENT_ON_RELOADED }
				...
				case 4:
					{
						...
						this._fWeaponGlowEffect_spr = this.weaponSprite.addChild(APP.library.getSprite("weapons/DefaultGun/glow"));
	...
	getAlternateSprite() 
	{
		...
		{
			case WEAPONS.INSTAKILL:
				alternate = APP.library.getSpriteFromAtlas('weapons/InstantKill/gun_on');
				//gun flares...
				for (let i = 0; i < 3; i++)
				{
	...
	getWeaponSprite()
	{
		...
		switch (this.id)
		{
			...
			case WEAPONS.HIGH_LEVEL:
				...
				//console.log("TURRET NAMES: ~~~~~~~~~~~~~~~~~" + lAssetName_str);
				break;
			case WEAPONS.INSTAKILL:
				lAssetName_str = "weapons/InstantKill/gun_off";
				break;
			case WEAPONS.CRYOGUN:
				let lPlayChargeSoundForCryogun_bl = (this._fIsSkipAnimation_bl !== true);
				return new Cryogun(this.isMaster, lPlayChargeSoundForCryogun_bl);
				break;
			case WEAPONS.RAILGUN:
				return new Railgun(this.isMaster);
				break;
			case WEAPONS.FLAMETHROWER:
	...
	getWeaponAsset()
	{
		...
		switch (this.id)
		{
			...
			case WEAPONS.CRYOGUN:
				...
				break;
			case WEAPONS.RAILGUN:
				lAssetName_str = "weapons/Railgun/railgun";
				break;
			case WEAPONS.FLAMETHROWER:
