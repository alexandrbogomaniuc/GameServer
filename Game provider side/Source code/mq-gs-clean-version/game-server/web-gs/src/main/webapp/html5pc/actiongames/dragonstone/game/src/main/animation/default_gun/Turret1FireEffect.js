...
class Turret1FireEffect extends Sprite
{
	...
	constructor()
	{
		...
		//DUST HORISONTAL...
		let l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_1/dg_fx_1/dust");
		...
		//DUST VERTICAL...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_1/dg_fx_1/dust");
		...
		//CIRCLE...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_1/dg_fx_1/circle");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
		...
		//FLASH...
		l_s = APP.library.getSpriteFromAtlas("weapons/DefaultGun/turret_1/dg_fx_1/flash");
		l_s.anchor.set(0.5, 0.5);
		l_s.blendMode = PIXI.BLEND_MODES.ADD;
		l_s.scale.set(0);
