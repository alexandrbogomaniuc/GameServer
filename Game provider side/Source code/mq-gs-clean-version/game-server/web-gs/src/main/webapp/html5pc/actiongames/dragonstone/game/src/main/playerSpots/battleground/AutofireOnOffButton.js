...
class AutofireOnOffButton extends PointerSprite
{
	...
	constructor()
	{
		...
		this._fIsActive_bl = APP.gameScreen.gameField.autofireButtonEnabled;
	...
	_init()
	{
		...
		let lButtonBack_spr = this._fBody_sprt.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_back"));
		...
		{
			//this._fONButtonView_spr = this._fButtonContainer_spr.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_on"));
			//this._fOFFButtonView_spr = this._fButtonContainer_spr.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_off"));
			this._fONButtonView_spr = this._fButtonContainer_spr.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_back"));
			this._fOFFButtonView_spr = this._fButtonContainer_spr.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_back"));
		}else
		{
			this._fONButtonView_spr = this._fButtonContainer_spr.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_back"));
			this._fOFFButtonView_spr = this._fButtonContainer_spr.addChild(APP.library.getSpriteFromAtlas("player_spot/playerspotbattleground/autofire_button_back"));
		...
		this._fText_ta.position.set(0, -1);
	...
	_changeState()
	{
		if(APP.gameScreen.gameField.isFinalCountingFireDenied) return;
