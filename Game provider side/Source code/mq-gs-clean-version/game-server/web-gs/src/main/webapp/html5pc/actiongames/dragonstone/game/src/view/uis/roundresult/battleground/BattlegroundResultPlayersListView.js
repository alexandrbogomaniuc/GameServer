...
class BattlegroundResultPlayersListView extends Sprite
{
	...
	_init()
	{
		...
		let lStroke_spr = this.addChild(APP.library.getSpriteFromAtlas("round_result/battleground/score_stroke"));
	...
	_addRow(aPositionY_num, aId_num, aAlpha_num)
	{
		...
		let lHr_spr = lRow_sprt.addChild(APP.library.getSpriteFromAtlas("round_result/battleground/line_hr_white"));
