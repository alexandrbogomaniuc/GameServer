...
class MissEffectLevel4 extends MissEffect
{
	...
	_addSphere()
	{
		const lSphere_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/circle_blast/circle_blast_4"));
		lSphere_spr.blendMode = PIXI.BLEND_MODES.SCREEN;
	...
	_addRedSmoke1()
	{
		const lRedSmoke1_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/explosion/explosion_4_5"));
	...
	_addRay1()
	{
		const lRedRay1_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/circle_blast/sparkle_red_4"));
	...
	_addRay2()
	{
		const lRedRay2_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/circle_blast/sparkle_red_4"));
	...
	_addRay3()
	{
		const lRedRay3_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/circle_blast/sparkle_red_4"));
	...
	_addRedSmoke2()
	{
		const lRedSmoke2_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/explosion/explosion_4_5"));
	...
	_addRedSmoke3()
	{
		const lRedSmoke3_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/explosion/explosion_4_5"));
	...
	_addRedSmoke4()
	{
		const lRedSmoke4_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/explosion/explosion_4_5"));
	...
	_addRedSmoke5()
	{
		const lRedSmoke5_spr = this.addChild(APP.library.getSpriteFromAtlas("enemy_impact/explosion/explosion_4_5"));
